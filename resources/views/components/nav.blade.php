<nav class="shadow-md sticky lg:static top-0 z-50 bg-white">
    <div class="flex items-center  p-6 lg:px-8" aria-label="Global">
        <div class="flex justify-between w-full lg:hidden">
            ...
            <label for="btn-side-menu" class="cursor-pointer flex items-center">
            ...
            <div
                class="peer-checked:translate-x-0 fixed z-30 top-0 right-0 h-full w-full sm:w-80  transform translate-x-full transition-transform duration-300">
                <div
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <label for="btn-side-menu" class="cursor-pointer">
                    ...
                    <div class="mt-6 flow-root">
                        <div class="-my-6 divide-y divide-gray-500/10">
                            <div class="space-y-2 py-6">
                                <a href="#"
                                    class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">Home
                                    Page</a>
                                <a href="#"
            ...
            <label for="btn-side-menu"
                class="peer-checked:block hidden fixed inset-0 backdrop-brightness-50 backdrop-blur-xs z-29 cursor-pointer"></label>
        </div>
